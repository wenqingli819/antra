...
- size from 1 megabyte (MB) to a technical limit of 1,048,516 terabytes .
...
### SQL Server Instance = DB Engine instance

- can have many instances on a machine but only 1 default instance
...
- There are two basic methods for handing off batches to SQL Server.
  ...
  1. GO : 
     ...
     - example
       ...
       consider as 1 batch![image-20210223120412927](..\resources\images\image-20210223120412927.png)
...
![image-20210223233630191](..\resources\images\image-20210223233630191.png)
...
![image-20210223234153518](C:\Users\wenqi\AppData\Roaming\Typora\typora-user-images\image-20210223234153518.png)

##### Approximate Numbers 

![image-20210223234320253](C:\Users\wenqi\AppData\Roaming\Typora\typora-user-images\image-20210223234320253.png)
...
e.g., ![image-20210223143002932](..\resources\images\image-20210223143002932.png)